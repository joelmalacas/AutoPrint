...
public class DefActivity extends AppCompatActivity {
    ...
    private void loadSettings() {
        ...
        int savedPort = prefs.getInt(KEY_PRINTER_PORT, 9100); // 9100 é a porta comum de impressoras de rede
        ...
        new Thread(() -> {
            ...
            runOnUiThread(() -> {
                if (finalReachable) {
                    ...
                    txtConnectionStatus.setText("Não foi possível ligar a este IP/porta");
                    txtConnectionStatus.setTextColor(0xFFD32F2F);
                }
            });
        }).start();
